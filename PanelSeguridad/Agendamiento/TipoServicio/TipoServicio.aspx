            ...
            <div id="Container_controls">
                ...
                <tr>
                    ...
                    <table id="Tabla_2" style="width: 700px; text-align: left;">
                        ...
                        <tr>
                            <td class="Label_Bold" style="width: 150px;">Nombre
                            </td>
                            <td style="width: 50px;">
                                <span class="cssToolTip_Form">
                    ...
                    <table id="Tabla_3" style="width: 700px; text-align: left;">
                        <tr>
                            <td style="width: 153px;" class="Label_Bold">Tipo Servicio
                            </td>
                    ...
                    <table id="Table_4" style="width: 700px; text-align: left;">
                        <tr>
                            <td style="width: 100px;" class="Label_Bold">Referecia
                            </td>
                            <td style="width: 150px;">
                                <span class="cssToolTip_Form">
                                    <input type="text" id="Text_Referencia" maxlength="5" class="Numeric" style="width: 70px;" />
                                    <span class="Spam_AN"></span></span>
                            </td>
                            <td style="padding-bottom: 25px; width: 340px;">
                                <span class="cssToolTip">

                ...
                <div id="Acordeon_Activo" style="width: 100%">
                    ...
                    <div id="DatosActivos">
                            ...
                            <tr>
                                ...
                                <td style="width: 11%;">
                                    <span class="cssToolTip_Form">
                                        <input type="text" id="TxtRef_1" maxlength="17" style="width: 170px;" />
                                ...
                                <td style="width: 11%;">
                                    <span class="cssToolTip_Form">
                                        <input type="text" id="TxtRef_2" maxlength="17" style="width: 170px;" />
                                        <span class="Spam_AST"></span></span>
                                </td>
                                <td style="width: 5%; padding-bottom: 25px;">
                                    <span class="cssToolTip">
                                ...
                                <td style="width: 11%;">
                                    <span class="cssToolTip_Form">
                                        <input type="text" id="TxtRef_3" maxlength="17" style="width: 170px;" />
                                        <span class="Spam_AST"></span></span>
                                </td>
                                <td style="width: 5%; padding-bottom: 25px;">
                                    <span class="cssToolTip">
                        ...
                        <table id="T_Datos_Identificacion" style="width: 100%;">
                            <tr>
                                <td class="Label_Bold" style="width: 10.5%;">Responsable
                                </td>
                                <td style="width: 46.5%;" colspan="3">
                                    <select id="Select_Persona_A" class="C_Chosen">
                                    </select>
                                </td>

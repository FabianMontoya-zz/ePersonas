<%@ Page Title="Usuarios - SASIF Personas" Language="vb" AutoEventWireup="false" MasterPageFile="~/Administrador/Sasif_menu.Master"
                ...
                <div id="TablaDatos">
                    ...
                    <div id="Detalle" style="width:100%;">
                        <table style="width: 100%;">
                            <tr>
                                <td id="TD6" style="width: 10.5%;" class="Label_Bold">NIT Empresa</td>
                                <td id="Ver_EmpresaNit" style="width: 40%; padding-left: 0.5em;"></td>
                                <td style="width: 60%; padding-bottom: 25px;"></td>
                            </tr>
                        </table>
                        <table style="width: 100%;" border="0">
                            <tr>
                                ...
                                <td id="Ver_ID" style="width: 17%;"></td>
                                <td style="padding-bottom: 25px; width: 15%;"></td>
                                <td style="width: 9.8%;" class="Label_Bold">Nombre
                                </td>
                                <td style="width: 27%;" id="Ver_Name"></td>
                                <td style="padding-bottom: 25px; width: 9%;"></td>
                            </tr>
                        </table>
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td id="Ver_TypeDocument" style="width: 40%; padding-left: 0.5em;"></td>
                                <td style="padding-bottom: 25px; width: 10%;"></td>
                                <td style="width: 10.5%;" class="Label_Bold">Documento
                                </td>
                                <td id="Ver_Document" style="width: 17%;"></td>
                                <td style="padding-bottom: 25px; width: 15%;"></td>
                            </tr>
                        </table>
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 10.5%;" class="Label_Bold">NIT Rol</td>
                                <td id="Ver_EmpresaNit_2" style="width: 40%; padding-left: 0.5em;"></td>
                                <td style="width: 60%; padding-bottom: 25px;"></td>
                            </tr>
                            <tr>
                                <td class="Label_Bold" style="width: 11%;">Rol
                                </td>
                                <td id="Ver_Rol" style="width: 40%;"></td>
                                <td style="width: 60%; padding-bottom: 25px;"></td>
                            </tr>
                        </table>
                        <table style="width: 100%;" border="0">
                            ...
                            <tr>
                                ...
                                <td id="Ver_PoliticaSeguridad_U" style="width: 20%;"></td>
                                <td style="padding-bottom: 25px; width: 80%;"></td>
                            </tr>
                            <tr>
                                <td class="Label_Bold">Seguridad de Grupo
                                </td>
                                <td id="Ver_PolSegurGrupo" style="width: 34%;"></td>
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td id="Ver_Acces_Information" style="width: 20%; padding-left: 0.5em;"></td>
                                <td style="padding-bottom: 25px; width: 80%;"></td>
                            </tr>
                        </table>
                        <table style="width: 100%;" border="0">
                            <tr>
                                ...
                                <td id="Ver_AccesInfoDocument" style="width: 20%; padding-left: 0.2em;"></td>
                                <td style="padding-bottom: 25px; width: 80%;"></td>
                            </tr>
                            <tr>
                                <td class="Label_Bold">A Documentos
                                </td>
                                <td id="Ver_AccessDocument"></td>
                                <td style="padding-bottom: 25px;"></td>
                            </tr>
                        </table>
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td id="Ver_Grupo_Documentos_U" style="width: 40%; padding-left: 0.5em;"></td>
                        ...
                        <table style="width: 100%;" border="0">
                            <tr>
                                ...
                                <td id="Ver_AccessInfoReports" style="width: 20%; padding-left: 0.2em;"></td>
                                <td style="padding-bottom: 25px; width: 80%;"></td>
                            </tr>
                            <tr>
                                <td class="Label_Bold">A Reportes
                                </td>
                                <td id="Ver_AccessReports"></td>
                                <td style="padding-bottom: 25px;"></td>
                            </tr>
                        </table>
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td id="Ver_GroupReports" style="width: 40%; padding-left: 0.5em;"></td>
                                <td style="padding-bottom: 25px; width: 60%;"></td>
                            </tr>
                        </table>
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td id="Ver_Token" style="width: 30%; padding-left: 0.5em;"></td>
                                <td style="padding-bottom: 25px; width: 70%;"></td>
                            </tr>
                        </table>
                        <table  style="width: 100%;" border="0">
                            <tr>
                                <td style="width: 10.5%;" class="Label_Bold">Tipo de Acceso
                                </td>
                                <td id="Ver_TypeAccess" style="width: 18%; padding-left: 0.1em;"></td>
                                <td style="padding-bottom: 25px; width: 13%;"></td>
                                <!-- Solo se muestra cuando es Actualizar -->
                                <td class="Label_Bold" style="width: 6%;">Estado del Usuario
                                </td>
                                <td id="Ver_EstadoUser" style="width: 20%;"></td>
                                <td style="padding-bottom: 25px; width: 22%;"></td>
                            </tr>
                        </table>
                    </div>

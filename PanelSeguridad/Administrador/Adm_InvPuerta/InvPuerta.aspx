<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Parametros/Sasif_menu.Master"
    CodeBehind="InvPuerta.aspx.vb" Inherits="PanelSeguridad.InvPuerta" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="InvPuerta.js" type="text/javascript"></script>
    <script src="InvPuertaTrasaccionsAjax.js" type="text/javascript"></script>
                            ...
                            <tr id="TR_Fechas">
                                ...
                                <td style="width: 100px;">
                                    <span class="cssToolTip_Form">
                                        <input type="text" id="TxtFechaInicial" readonly="readonly" style="width: 100px;" />
                                ...
                                <td style="width: 100px;">
                                    <span class="cssToolTip_Form">
                                        <input type="text" id="TxtFechaFinal" readonly="readonly" style="width: 100px;" />
                                        <span class="Spam_AF"></span></span>
                                </td>
                                <td style="padding-bottom: 25px; width: 80px;">
                                    <span class="cssToolTip">

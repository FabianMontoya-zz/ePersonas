Public Class ConsecutivosClass

#Region "campos"
    Private _Index As Long
    Private _Nit_ID As String
    Private _Consecutivo_ID As String
...
#Region "propiedades"
    ...
    Public Property Nit_ID() As String
        ...
        End Set
    End Property
    Public Property Consecutivo_ID() As String
        Get
            Return Me._Consecutivo_ID
        End Get
        Set(ByVal value As String)
            Me._Consecutivo_ID = value
        End Set
    End Property

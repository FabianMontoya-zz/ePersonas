<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Parametros/Sasif_menu.Master"
    CodeBehind="Consecutivos_General.aspx.vb" Inherits="PanelSeguridad.Consecutivos_General" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="Consecutivos_General.js" type="text/javascript"></script>
        ...
        <div id="Marco_trabajo_Form">
            <div id="Container_controls">
                <table id="TablaConsulta">
                    ...
                    <tr>
                        <td colspan="4">
                            <div id="container_TConsecutivos_General">
                            </div>
                        </td>
                    </tr>
                </table>

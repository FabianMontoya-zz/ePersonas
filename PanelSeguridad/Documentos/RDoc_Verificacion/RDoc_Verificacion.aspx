<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Parametros/Sasif_menu.Master"
    CodeBehind="RDoc_Verificacion.aspx.vb" Inherits="PanelSeguridad.RDoc_Verificacion" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery-1.4.1.js" type="text/javascript"></script>
    <script src="../../SasifMaster.js" type="text/javascript"></script>
    <script src="../SasifMaster_Cosult.js" type="text/javascript"></script>
    <script src="RDoc_Verificacion.js" type="text/javascript"></script>
    <script src="RDoc_VerificacionTrasaccionsAjax.js" type="text/javascript"></script>
                ...
                <div id="TablaDatos_D">
                    ...
                    <table id="Tabla_2" style="width: 700px; text-align: left;">
                        <tr>
                            ...
                            <td>
                                <select id="Select_Documento_1" class="C_Chosen">
                                </select>
                            </td>
                    ...
                    <table id="Tabla_3" style="width: 700px; text-align: left;">
                        <tr>
                            ...
                            <td>
                                <select id="Select_Documento_2" class="C_Chosen">
                                </select>
                            </td>
                            <td style="padding-bottom: 25px; width: 300px;">

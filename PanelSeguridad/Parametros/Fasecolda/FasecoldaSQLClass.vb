...
#Region "CRUD"
    ...
    Public Function Read_AllFasecolda(ByVal vp_S_Filtro As String, ByVal vp_S_Opcion As String, ByVal vp_S_Contenido As String)
        ...
        ObjListFasecolda = listFasecolda(StrQuery, Conexion, "List")
...
#Region "CARGAR LISTAS"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function listFasecolda(ByVal vp_S_StrQuery As String, ByVal vg_S_StrConexion As String, ByVal vp_S_TypeList As String)
...
#Region "OTRAS CONSULTAS"
    ...
    ''' <summary>
    ''' trae la matrix fasecolda con valores
    ''' </summary>
    ''' <returns></returns>
    ''' <remarks></remarks>

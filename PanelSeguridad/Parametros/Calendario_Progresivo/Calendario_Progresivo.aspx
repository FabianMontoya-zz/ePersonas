...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Calendario_Progresivo.js" type="text/javascript"></script>
    <script src="Calendario_ProgresivoTransaccionAjax.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <div id="Dialog_Calendar">
        <div class="Header_Datos_Max">
            ...
            <table id="T_Rango" style="width: 50%; text-align: left;">
                <tr>
    ...
    <%-- Dialog para escribir las horas --%>
    ...
    <%-- Dialogo para hacer la edición de las horas --%>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Parametros/Sasif_menu.Master"
    CodeBehind="CalendarioProgresivo.aspx.vb" Inherits="PanelSeguridad.CalendarioProgresivo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="CalendarioProgresivoTrasaccionsAjax.js" type="text/javascript"></script>
            ...
            <div id="Container_controls">
                ...
                <div id="TablaDatos_D">
                    ...
                    <table id="Tabla_2" style="width: 700px; text-align: left;">
                        <tr>
                            <td style="width: 150px;" class="Label_Bold">Calendario
                            </td>
                            <td style="width: 70px;">
                            ...
                            <td class="Label_Bold" style="width: 80px;">Fecha
                            </td>
                            <td style="width: 200px;">
                                <span class="cssToolTip_Form">
                                    <input type="text" id="Txtfecha" readonly="readonly" style="width: 100px;" />
                    ...
                    <table id="Tabla_3" style="width: 700px; text-align: left;">
                        <tr>
                            <td style="width: 150px;" class="Label_Bold">Hora Inicial
                            </td>
                            <td>
                                <span class="cssToolTip_Form">
                                    <input type="text" id="txt_HI" style="width: 80px;" maxlength="5" class="Hours"
                                        readonly="readonly" />
                        ...
                        <tr>
                            <td style="width: 150px;" class="Label_Bold">Hora Final
                            </td>
                            <td>
                                <span class="cssToolTip_Form">
                                    <input type="text" id="txt_HF" style="width: 80px;" maxlength="5" class="Hours"
                                        readonly="readonly" />
                                    <span class="Spam_AH"></span></span>
                            </td>
                            <td style="padding-bottom: 25px; width: 320px;">
